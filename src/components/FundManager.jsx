...
const COMPANIES = [
  { label: 'BBL (บัวหลวง)',         value: 'BBL' },
  { label: 'KASIKORN (กสิกรไทย)',   value: 'KASIKORN' },
  { label: 'SCB (ไทยพาณิชย์)',      value: 'SCB' },
  { label: 'Krungsri (กรุงศรี)',     value: 'Krungsri' },
  { label: 'KTAM (กรุงไทย)',        value: 'KTAM' },
  { label: 'TTB (ทหารไทยธนชาต)',    value: 'TMB' },
  { label: 'ONE (วรรณ)',            value: 'ONE' },
  { label: 'LHFUND (แลนด์แอนด์เฮ้าส์)', value: 'LHFUND' },
  { label: 'TISCO',                 value: 'TISCO' },
  { label: 'Phatra (ภัทร)',         value: 'Phatra' },
  { label: 'MFC',                   value: 'MFC' },
  { label: 'Aberdeen (อเบอร์ดีน)',   value: 'Aberdeen' },
  { label: 'อื่นๆ / ไม่ระบุ',       value: '' },
];
